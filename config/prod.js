'use strict';
const WEAPP_SSO_API =
    process.env.WEAPP_SSO_API || '"https://sso.doctorwork.com/v1"';
const WEAPP_PUB_API =
    process.env.WEAPP_PUB_API ||
    '"https://public.doctorwork.com/base-rest/v1"';
const WEAPP_APP_API =
    process.env.WEAPP_APP_API ||
    'https://healthapp.doctorwork.com/mobile/v1';
const ACTIVITY_DOMAIN =
    process.env.ACTIVITY_DOMAIN ||
    '"https://web.doctorwork.com/rapp/activity"';
const GRAPHQL_PATH =
    process.env.REACT_APP_GRAPHQL_PATH || 'http://localhost:7001';
const WEAPP_DOMAIN =
    process.env.WEAPP_DOMAIN || 'https://web.doctorwork.com/';
...
module.exports = {
    ...
    h5: {
        devServer: {
            proxy: [
                {
                    target: 'https://sso.doctorwork.com/v1',
                    pathRewrite: {
                        '^/sso': ''
                    },
                    context: ['/sso'],
